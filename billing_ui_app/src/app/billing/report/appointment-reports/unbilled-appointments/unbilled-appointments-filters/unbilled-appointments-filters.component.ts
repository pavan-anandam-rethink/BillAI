...
@Component({
  selector: 'unbilled-appointments-filters',
  templateUrl: './unbilled-appointments-filters.component.html',
  styleUrls: ['./unbilled-appointments-filters.component.css']
})
export class UnbilledAppointmentsFiltersComponent implements OnInit {
  ...
  selectedAnchor: any;
  isAllStaffSelected: boolean = true;
