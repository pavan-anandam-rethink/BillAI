...
@Component({
    selector: 'claim-filters-calendar-popup',
    templateUrl: './claim-filters-calendar-popup.component.html',
    styleUrls: ['./claim-filters-calendar-popup.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ClaimFiltersCalendarPopupComponent implements OnInit, OnDestroy{
