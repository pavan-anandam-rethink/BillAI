...
@Component({
    selector: 'payment-posting-list-action',
    templateUrl: './payment-posting-list-action.component.html',
    styleUrls: ['./payment-posting-list-action.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PaymentPostingListActionComponent {
