/****** Object:  StoredProcedure [dbo].[GetClaimsByAccountInfoId]    Script Date: 3/5/2026 12:26:55 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT
	  ...
	  CONCAT(isnull(clientSearchClaim.firstName, ''), ISNULL(' '+ clientSearchClaim.middleName + ' ', ' '), clientSearchClaim.lastName) as patientName,
      cvec.ErrorsCount,
      cvec.WarningsCount,
