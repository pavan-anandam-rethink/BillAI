...
IF EXISTS (SELECT 1 FROM sys.columns WHERE Name = 'IsSecondaryPayerAvailable' AND Object_ID = Object_ID('dbo.claims'))  
BEGIN  
  
   ALTER TABLE dbo.claims  
   DROP CONSTRAINT DF_claims_IsSecondaryPayerAvailable
   
   ALTER TABLE dbo.claims  
   DROP COLUMN IsSecondaryPayerAvailable    
END
GO

ALTER PROCEDURE [dbo].[GetClaimsByAccountInfoId]
--EXEC [dbo].[GetClaimsByAccountInfoId] 18421,0,50,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,0,NULL
(
	@AccountInfoId int,     
	@Skip int, @Take int, 
