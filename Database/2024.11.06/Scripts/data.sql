...
BEGIN
	UPDATE DBO.Claims SET hcProviderLocationId = 8524 WHERE accountInfoId = 25525 and id in (144,145,146,147,148,149,150,151,152,153,154,155,156,165,166,167,168,170,171)
END 
GO
