namespace EdiFabric.Templates.Hipaa5010.PreErrata
{
    ...
    public class Loop_2010AB_837D
    {
        ...
        [Required]
        [Pos(2)]
        public virtual N3_AmbulanceDrop N3_Pay_Address_ADDRESS { get; set; }
        /// <summary>
        ...
        [Required]
        [Pos(3)]
        public virtual N4_AmbulanceDrop N4_Pay_Address_City_State_ZIPCode { get; set; }
    }
    ...
    public class Loop_2330E_837D
    {
        ...
        [ListCount(3)]
        [Pos(2)]
        public virtual List<REF_AssistantSurgeonSecondaryIdentification_2> REF_OtherPayerSupervisingProviderIdentification { get; set; }
    }
    ...
    public class Loop_2330H_837D
    {
        ...
        [ListCount(3)]
        [Pos(2)]
        public virtual List<REF_AssistantSurgeonSecondaryIdentification_2> REF_OtherPayerAssistantSurgeonSecondaryIdentifier { get; set; }
    }
    ...
    public class Loop_2400_837D
    {
        ...
        [Required]
        [Pos(1)]
        public virtual LX_HeaderNumber LX_ServiceLineCounter { get; set; }
        /// <summary>
        /// Dental Service
        /// </summary>
        [DataMember]
