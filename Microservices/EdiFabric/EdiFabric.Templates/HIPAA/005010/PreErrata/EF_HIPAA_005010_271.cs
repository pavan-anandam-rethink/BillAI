namespace EdiFabric.Templates.Hipaa5010.PreErrata
{
    ...
    public class Loop_2100C_271
    {
        ...
        [DataMember]
        [Pos(6)]
        public virtual PRV_ProviderInformation_3 PRV_ProviderInformation { get; set; }
        /// <summary>
        ...
        [DataMember]
        [Pos(9)]
        public virtual HI_DependentHealthCareDiagnosisCode_4 HI_SubscriberHealthCareDiagnosisCode { get; set; }
        /// <summary>
        /// Subscriber Date
        /// </summary>
        [DataMember]
        [ListCount(9)]
        [Pos(10)]
        public virtual List<DTP_DependentDate_2> DTP_SubscriberDate { get; set; }
        /// <summary>
    ...
    public class Loop_2100D_271
    {
        ...
        [DataMember]
        [Pos(3)]
        public virtual N3_AmbulanceDrop N3_DependentAddress { get; set; }
        /// <summary>
        /// Dependent City, State, ZIP Code
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual N4_AmbulanceDrop N4_DependentCity_State_ZIPCode { get; set; }
        /// <summary>
        ...
        [ListCount(9)]
        [Pos(10)]
        public virtual List<DTP_DependentDate_2> DTP_DependentDate { get; set; }
        /// <summary>
    ...
    public class Loop_2120C_271
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual N3_AmbulanceDrop N3_SubscriberBenefitRelatedEntityAddress { get; set; }
        /// <summary>
    ...
    public class Loop_2120D_271
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual N3_AmbulanceDrop N3_DependentBenefitRelatedEntityAddress { get; set; }
        /// <summary>
