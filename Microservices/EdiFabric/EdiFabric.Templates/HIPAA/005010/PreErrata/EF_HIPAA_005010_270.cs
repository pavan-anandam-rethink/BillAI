namespace EdiFabric.Templates.Hipaa5010.PreErrata
{
    ...
    public class Loop_2100B_270
    {
        ...
        [DataMember]
        [Pos(3)]
        public virtual N3_AmbulanceDrop N3_InformationReceiverAddress { get; set; }
        /// <summary>
        /// Information Receiver City, State, ZIP Code
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual N4_AmbulanceDrop N4_InformationReceiverCity_State_ZIPCode { get; set; }
        /// <summary>
    ...
    public class Loop_2100C_270
    {
        ...
        [ListCount(2)]
        [Pos(9)]
        public virtual List<DTP_DependentDate> DTP_SubscriberDate { get; set; }
        /// <summary>
    ...
    public class Loop_2100D_270
    {
        ...
        [ListCount(2)]
        [Pos(9)]
        public virtual List<DTP_DependentDate> DTP_DependentDate { get; set; }
        /// <summary>
