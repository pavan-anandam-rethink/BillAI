namespace EdiFabric.Templates.Hipaa5010
{
    ...
    public class C042
    {
        ...
        [DataMember]
        [Pos(1)]
        public virtual string AdjustmentReasonCode_01 { get; set; }
        [DataMember]
        [Pos(2)]
        public virtual string ProviderAdjustmentIdentifier_02 { get; set; }
    }
    ...
    public class C043
    {
        ...
        [DataMember]
        [Pos(1)]
        public virtual string HealthCareClaimStatusCategoryCode_01 { get; set; }
        [DataMember]
        [Pos(2)]
        public virtual string StatusCode_02 { get; set; }
        [DataMember]
        [Pos(3)]
