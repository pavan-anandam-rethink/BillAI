...
namespace BillingService.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Correlation ID: register IHttpContextAccessor and the HTTP-backed provider
            // so any service that injects ICorrelationIdProvider gets the request-scoped ID.
