...
namespace BillingService.Domain.Models.RulesEngine
{
    ...
    public class ClaimRulesEngineViolation
    {
        public string RuleId { get; set; }
        public string Message { get; set; }
        public ClaimRulesEngineSeverity Severity { get; set; }
        public IDictionary<string, string> Metadata { get; set; } = new Dictionary<string, string>();
    }

    public enum ClaimRulesEngineSeverity
    {
        Warning = 0,
        Error = 1
    }
