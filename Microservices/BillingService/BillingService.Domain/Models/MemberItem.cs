using BillingService.Domain.DataObjects;
...
namespace BillingService.Domain.Models
{
    public class MemberItem
    {
        ...
        public bool? HideFreeCallReminder { get; set; }

        //public List<StaffMember> StaffMembers { get; set; }
        public AccountInfoItem AccountInfo { get; set; }
        //public List<StaffMemberLocation> StaffMemberLocations { get; set; }
        //public List<StaffServiceItem> StaffServices { get; set; }
