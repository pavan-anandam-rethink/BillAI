...
{
    [Owned]
    public class RethinkStaffMemberList
    {
        public int total { get; set; }
        public List<RethinkStaffMember> data { get; set; }
    }
    [Owned]
    public class RethinkStaffMember
    {
        ...
        public ClientTimezonesModel Timezone { get; set; }
        public RethinkAccountMember Member { get; set; }
